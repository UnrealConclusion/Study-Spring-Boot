...
import com.unrealconclusion.OneToOne.entity.Review;
...
public class OneToOneApplication {
	...
	private void createCourseAndReview(AppDAO appDAO) {
		// create a course
		Course course = new Course("Introduction to Boating");

		// add some reviews 
		course.addReview(new Review("I failed my boating exam!"));
		course.addReview(new Review("Some kid crashed his boat into the school!"));
		course.addReview(new Review("The teacher went insane!"));

		appDAO.save(course);
	}

	private void retrieveCourseAndReviews(AppDAO appDAO) {
		// fetch course and review
		int id = 10;
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		Course course = new Course("Advanced Surfing");
		Student student1 = new Student("Larry", "Lobster", "LL@GooLagoon.com");
		Student student2 = new Student("Sandy", "Cheeks", "Sandy@TreeDome.com");
		course.addStudent(student1);
		course.addStudent(student2);
		System.out.println("Saving courses and students");
		appDAO.save(course);
	}
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course course1 = new Course("Advanced Karate");
		Course course2 = new Course("Advanced Science");
